...
const Sidebar = () => {
  ...
  return (
    <aside className="hidden lg:flex w-64 bg-[#0A0A0F]/60 backdrop-blur-2xl border-r border-white/10/50 h-screen fixed left-0 top-0 p-6 flex-col z-20 shadow-[4px_0_24px_rgba(0,0,0,0.02)]">
      {/* Brand */}
      <div className="mb-10 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-bold tracking-tight text-white">Zolix</h1>
          <p className="text-[11px] font-medium text-slate-400 uppercase tracking-wider">Workspace</p>
        </div>
      </div>
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  `flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 group relative ${
                    isActive
                      ? "text-indigo-600 bg-indigo-500/10/80 font-medium shadow-[0_0_15px_rgba(0,0,0,0.5)] border border-indigo-500/20/50"
                      : "text-slate-400 hover:bg-[#0A0A0F] hover:shadow-[0_0_15px_rgba(0,0,0,0.5)] hover:text-white font-medium"
                  }`
                }
              >
                {({ isActive }) => (
      ...
      {/* Bottom */}
      <div className="mt-auto pt-6 border-t border-white/10/50">
        <div className="rounded-2xl bg-gradient-to-br from-slate-900 to-slate-800 p-5 shadow-xl relative overflow-hidden group hover:shadow-indigo-500/20 transition-all duration-300">
          ...
          <button className="w-full py-2 bg-[#0A0A0F]/10 hover:bg-[#0A0A0F]/20 text-white text-xs font-medium rounded-lg transition-colors backdrop-blur-sm">
            Upgrade Now
          </button>
        </div>
      </div>
